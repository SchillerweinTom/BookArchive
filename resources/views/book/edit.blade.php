        ...
        <div class="col-md-8 offset-md-2">
            ...
            <form action="{{ route('book.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="title" name="title" class="form-control w-75" value="{{ old('title', $book->title) }}">
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="pages" name="pages" class="form-control w-25" value="{{ old('pages', $book->pages) }}" min="1">
                    @error('pages')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if($book->image)
                        <div class="mt-2">
                            <img src="{{ asset('images/' . $book->image) }}" alt="Book Image" class="img-thumbnail" width="150">
                        </div>
                    @endif
                </div>
